...
# for infobar,
# <widget source="session.Event_Now" render="YouchiePoster" position="100,100" size="185,278" />
# <widget source="session.Event_Next" render="YouchiePoster" position="100,100" size="100,150" />
# <widget source="session.Event_Now" render="YouchiePoster" position="100,100" size="185,278" nexts="2" />
# <widget source="session.CurrentService" render="YouchiePoster" position="100,100" size="185,278" nexts="3" />

# for ch,
# <widget source="ServiceEvent" render="YouchiePoster" position="100,100" size="185,278" />
# <widget source="ServiceEvent" render="YouchiePoster" position="100,100" size="185,278" nexts="2" />

# for epg, event
# <widget source="Event" render="YouchiePoster" position="100,100" size="185,278" />
# <widget source="Event" render="YouchiePoster" position="100,100" size="185,278" nexts="2" />
# or put tag -->  path="/media/hdd/poster"
from __future__ import print_function
from Components.Renderer.Renderer import Renderer
from Components.Renderer.YouchieDownload import YouchieDownload
...
import traceback
import datetime
from .YouchieLib import convtext
...
class PosterDB(YouchieDownload):
    def __init__(self):
        YouchieDownload.__init__(self)
        self.logdbg = None
        self.pstcanal = None
...
class PosterAutoDB(YouchieDownload):
    def __init__(self):
        YouchieDownload.__init__(self)
        self.logdbg = None
        self.pstcanal = None
