...
# Modded and recoded by MCelliotG for use in Youchie-PLI-FHD skins or standalone, added Python3 support
# If you use this Converter for other skins and rename it, please keep the lines above adding your credits below
# Edit By @Youchie for OpenBH 04.02.2025
...
class YouchiePLIauinfo2(Poll, Converter, object):
    GET_AUDIO_ICON = 0
    GET_AUDIO_CODEC = 1
    ...
    def getAudioCodec(self, info):
        ...
        # Force "HE-AAC" to be displayed as "AAC" and show AAC icon
        if "HE-AAC" in description_str:
            description_str = description_str.replace("HE-AAC", "AAC")  # Change HE-AAC to AAC for all cases
