...
def cutName(eventName=""):
    if eventName:
        ...
        eventName = eventName.replace('قسمت', '').replace('سریال', '').replace('فیلم', '').replace('مستند', '').replace('برنامه', '').replace('تکرار', '').replace('پخش', '').replace('سینمایی', '')
        eventName = eventName.replace('ایرانی', '').replace('سینمایی ایرانی', '').replace('سریال ایرانی', '').replace('باز پخش', '').replace('تیزر', '').replace('آنونس', '')
        eventName = eventName.replace('فیلم سینمایی', '').replace('مجموعه', '').replace('مجموعه تلوزیونی', '')
