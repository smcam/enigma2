...
#  Edit By Youchie 2024-11-05 15:13:11 UTC (1730819591)
#  Youchie-PLI-FHD Converter for Enigma2
# zmiana strategii ladowanie modulow w py2 z relative na absolute jak w py3
...
class YouchieCaidInfo2(Poll, Converter, object):
    CAID = 0
    PID = 1
    PROV = 2
    ALL = 3
                ...
                if self.type == self.IS_Net:
                    if using == "CCcam":
                        ...
                        if source != "cache" and source == "Net" and source.find("emu") == -1:
                            return True
                            # return  (source != None and source == "Net") or (source != None and source != "EMU") or (source != None and source != "emu") or (reader != None and reader != "emu") or (source != None and source != "card")
                else:
                    return False
            ...
            if not info:
                ...
                if self.NUM_CI and self.NUM_CI > 0:
                    ...
                    if CIinfo == '' and softCamName == '':
                        return _("No Data From Cam")
                    elif CIinfo == '':
                        return _("No Data From Cam and Emulator")
                    else:
                        return _(CIinfo)
                else:
                    ...
                    if x != -1:
                        ...
                        if len(item) > 1:
                            ...
                            # cccam block
                                ...
                                if item[1].strip() == "emu" or item[1].strip() == "EMU":
                                    item[0] = "source"
                                else:
                                    info["source"] = "Net"
                                    item[0] = "protocol"
