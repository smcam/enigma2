#   Youchie-PLI-FHD converter
from Components.Converter.Converter import Converter
from Components.Element import cached


class YouchieRouteInfo(Converter, object):
    Info = 0
    Lan = 1
    Wifi = 2
    Modem = 3
    ...
    def getBoolean(self):
        ...
        for line in open('/proc/net/route'):
            if self.type == self.Lan and line.split()[0] == 'eth0' and line.split()[3] == '0003':
                info = True
            elif self.type == self.Wifi and (
                line.split()[0] in ['wlan0', 'wlan1', 'wlan2', 'ra0']
            ) and line.split()[3] == '0003':
                info = True
